/// Display text and variables in the <b>Output<> panel.
...
/// To quickly insert <see cref="print.it"/> code, use snippet <.x>piPrintItSnippet<> or <.x>outPrintItSnippet<>: type `pi` or out and select from the list.
///
...
/// Display text in a message box. To insert <see cref="dialog.show"/> code can be used <.x>dsDialogShowSnippet<>.
