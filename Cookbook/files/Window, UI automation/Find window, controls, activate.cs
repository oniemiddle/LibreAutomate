...
/// - Tools in the <b>Code<> menu: <b>Find window<> (`Ctrl+Shift+W`), <b>Input recorder<>.
/// - Hotkey `Ctrl+Shift+Q`.
/// - Snippet <.x>winFindSnippet<>. You can see window properties in panel <b>Mouse<>.

/// Find window and create variable <i>w1<> that contains window handle. Window name must end with `"- Notepad"`; class name must be `"Notepad"`. Can wait/retry max 1 s; exception if not found. Activate when found.
...
/// To create <see cref="wnd.Child"/> code can be used the same tools as for <.x>wnd.find<>.
