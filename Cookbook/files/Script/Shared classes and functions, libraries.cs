...
///
/// 3. Put the classes in file <open>global.cs<>. Or in class files added to `global.cs`. Use this only for classes that should be available in ALL code files (script, class) of current workspace. Also in `global.cs` you can add library references: in the <b>Properties<> dialog click <b>Library<>.
