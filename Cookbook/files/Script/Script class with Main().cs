/// The default script syntax is known as <google>C# top-level statements<>. You can instead use the classic C# syntax with class <.x>Program<> and function <.x>Main<>. To insert code can be used menu <b>Edit > Generate > Add function Main<>.
