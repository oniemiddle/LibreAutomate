...
/// 
/// 2. Run the script without the editor. For it need to <help editor/Creating exe programs>create exe program<> from the script. Then launch it like any other program. Example:
///
/// 	`C:\Test\Script5.exe`
///
