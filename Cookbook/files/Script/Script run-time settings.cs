...
/// The <b>ifRunning<> option isn't applied if the `.exe` script is launched not from the editor. Then function <see cref="script.single"/> can be used to ensure single process instance.
