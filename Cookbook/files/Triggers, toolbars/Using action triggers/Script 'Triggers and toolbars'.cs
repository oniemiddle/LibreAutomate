/// It is recommended to keep toolbars and keyboard/autotext/mouse/window triggers in folder `@Triggers and toolbars`. It contains script `Triggers and toolbars`, split into multiple files. Click a <b>TT<> menu item to open a file; it creates the folder/file if need.
/// 
...
/// 
/// To disable a trigger, comment out the trigger code line. Then click <b>Run<> to restart. To disable/enable all triggers, use the tray icon menu or menu <b>TT<>. Also you can comment out the `[Triggers]` attribute to disable all triggers defined there. See also class <see cref="Au.Triggers.ActionTriggers"/> examples.
/// 
