/// Function <see cref="Au.Triggers.ActionTriggers.ShowTriggersListWindow"/> shows a temporary window with a list of currently active triggers for the active window (hotkey, autotext and mouse edge/move triggers) or the mouse window (mouse click/wheel triggers).
