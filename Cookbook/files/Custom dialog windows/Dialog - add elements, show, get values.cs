/// Class <see cref="wpfBuilder"/> allows to create <google>WPF<> dialog windows quite easily without a visual designer. To start creating a dialog, use snippet <.x>wpfDialogSnippet<>: type `wpf` and select from the list. Or menu <b>File > New > Dialogs<>.
