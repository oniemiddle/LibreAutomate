...
/// The API is old, not convenient to use, not type-safe. You can instead use libraries that read-write Excel files directly without opening in Excel. See cookbook recipes in folder `Excel files`.
